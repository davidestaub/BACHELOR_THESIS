...
public:
    TestApp(int w, int h, const char * title) : Application(title, w, h) {
        ...
        circleKey = {{width/2-200, height/2-100}, 30, COLOR_OUT, nvgRGBA(50, 50, 50, 100)};
        circleMouse = {{width/2-200, height/2+100}, 20, COLOR_OUT, nvgRGBA(50, 50, 50, 100)};
        rect = Box{{width/2+200, height/2}, Vector2f(100, 150), nvgRGBA(50, 50, 50, 100), nvgRGBA(50, 50, 50, 200)};
...
int main(int, char**)
{
    ...
    Particle particle_1(1.0*std::pow(10,-3), 1.0 * std::pow(10,-6));
    Particle particle_2;
